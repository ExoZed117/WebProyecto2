  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a name="" id="" class="btn btn-success" href="<?php echo base_url().'agregarAdministracion'?>" role="button">Agregar</a>
            </div>
        </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php foreach ($registros as $usuario) : ?>
                        <tr>
                            ...
                            <td>
                                <a name="" id="" class="btn btn-warning" href="<?php echo base_url().'updateFormAdministracion/'.$usuario['idUsuario']?>" role="button"><i class="nav-icon fas fa-edit"></i></a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger" id="deleteUserLink" href="#">Eliminar</a>
